                ...
                R = function(a) {
                    if (a.source === j && !(a.widgetId === void 0 || a.widgetId === "" || !m.widgetMap.has(a.widgetId))) {
                        ...
                        if (n !== void 0) switch (a.event) {
                            case "init":
                                {
                                    n.widgetInitStartTimeTsMs = $(),
                                    n.kills = a.kills;
                                    var c = n.shadow.getElementById(u);c === null && h("Cannot initialize Widget, Element not found (#".concat(u, ")."), 3074),
                                    n.mode = a.mode,
                                    n.nextRcV = a.nextRcV,
                                    n.mode === ge.Invisible && n.params["refresh-expired"] === Fe.Manual && x("refresh-expired=manual is impossible in invisible mode, consider using '".concat(Fe.Auto, "' or '").concat(Fe.Never, ".'")),
                                    n.mode !== ge.Managed && n.params["refresh-timeout"] !== Ye.Auto && x("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                    n.params.appearance === ye.Always || n.isExecuting && n.params.appearance === ye.Execute ? wt(c, n) : Pn(c),
                                    c.style.display = "";
                                    var b = ke(n, u);b || h("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                    de(b, {
                                        event: "init",
                                        source: j,
                                        widgetId: a.widgetId
                            ...
                            case "translationInit":
                                {
                                    var g = n.shadow.getElementById(u);g === null && h("Cannot initialize Widget, Element not found (#".concat(u, ")."), 3074);
                                    var O = new Map;n.displayLanguage = a.displayLanguage,
                                    n.displayRtl = a.displayRtl,
                                    Object.keys(a.translationData).forEach(function(_e) {
                            ...
                            case "languageUnsupported":
                                {
                                    x("Language ".concat(n.params.language, " is not supported, falling back to: ").concat(a.fallback, ".")),
                            ...
                            case "overrunBegin":
                                {
                                    n.isOverrunning = !0,
                                    n.watchcat.overrunBeginSeq = n.watchcat.lastAckedSeq;
                                    break
                                }
                            case "overrunEnd":
                                {
                            ...
                            case "fail":
                                {
                                    ...
                                    n.isFailed = !0,
                                    n.isInitialized = !0,
                                    a.frMd !== void 0 && a.frMd !== "" && (n.frMd = a.frMd),
                                    sr(n, u);
                                    var se = n.cbError,
                            ...
                            case "feedbackInit":
                                {
                                    ...
                                    n.feedbackOpen = !0,
                                    n.retryTimeout != null && (clearTimeout(n.retryTimeout), n.retryTimeout = void 0, n.pendingRetry || (n.pendingRetry = {
                                        crashed: !1
                                    })),
                                    rn(),
                                    window.postMessage({
                            ...
                            case "requestFeedbackData":
                                {
                                    var oe = ke(n, u);oe || h("Received state for an unknown widget: #".concat(u, " / ").concat(a.widgetId), 3078),
                                    de(oe, {
                            ...
                            case "closeFeedbackReportIframe":
                                {
                                    var ut = Ct(n, u).targetWindow;ut || h("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                    rt("".concat(u, "-fr")),
                                    Ue(n),
                                    i(n, u, a.widgetId);
                                    break
                            ...
                            case "tokenExpired":
                                {
                                    var y, He = a.token;n.isExpired = !0,
                                    (y = n.cbExpired) === null || y === void 0 || y.call(n, He),
                                    n.params["refresh-expired"] === Fe.Auto && !n.isResetting && k(K.AutoExpire, u);
                                    break
                                }
                            ...
                            case "interactiveBegin":
                                {
                                    var ue, lt = n.shadow.getElementById(u);lt || h("Cannot layout widget, Element not found (#".concat(u, ")."), 3076),
                                    (ue = n.cbBeforeInteractive) === null || ue === void 0 || ue.call(n),
                                    n.params.appearance === ye.InteractionOnly && wt(lt, n);
                                    break
                                }
                            case "interactiveEnd":
                                {
                            ...
                            case "requestExtraParams":
                                {
                                    ...
                                    var ze = ke(n, u);ze || h("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                    n.isResetting = !1;
                                    var Nt = {},
                                        Lt = $(),
                                        Pt = {
                                    ...
                                    le !== void 0 && le !== "" && le.length > Jr && (le = void 0),
                                    de(ze, Te({
                                        action: n.action,
                                        apiJsMismatchReloadAttempts: m.apiJsMismatchReloadAttempts,
                                        apiJsMismatchReloadCompletedCount: m.apiJsMismatchReloadCompletedCount,
